...
let x = 20;
let y = 4;
console.log("add", x+y);//24
console.log("sub", x-y);//16
console.log("mul", x*y);//80
console.log("div", x/y);//5
console.log("modulus", x%y);//0
console.log("expon", x**y);//160000
console.log("preincre", ++x);//21
console.log("predecre", --y);//3
console.log("before postincre value",x++)//21
console.log("after postincre value", x);//22
console.log("before postdecre value", y--);//3
console.log("after postdecre value", y);//2

//Assignment:-
let z = 8;
z+=2;
console.log("add and assign",z)//10
z-=2;
console.log("sub and assign",z)//8
z*=2;
console.log("mul and assign",z)//16
z/=2;
console.log("div and assign",z)//8
z%=2;
console.log("modulus and assign",z)//0

//comparison:-
let x1 = 8;
let y1 = 4;
console.log("equal to",x1 == y1);//false
console.log("not equal to",x1 != y1);//true
console.log("strict equal to",x1 === y1);//false
console.log("strct not equal to",x1 !== y1);//true
console.log("greater than",x1 > y1);//true
console.log("less than",x1 < y1);//false
console.log("greater than or equal to",x1 >= y1);//true
console.log("less than or equal to",x1 <= y1);//false

//logocal:-
let x2 = 10;
let y2 = 5;
console.log("and",(x2>y2) && (y2<x2));//true
console.log("or",(x2>y2) || (y2<x2));//true
console.log("not",!(x2>y2));//false
//bitwise:-
/*  
